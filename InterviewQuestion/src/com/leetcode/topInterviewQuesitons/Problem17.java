...
public class Problem17 
{
	...
	public static List<String> letterCombination(String digits)
	{
		...
		recursiveCall(digits,0,map,arr,result);
		
		return result;
	}
	
	public static void recursiveCall(String digits, int index, Map<Character, char[]> map, char[] arr, List<String> result )
	{
		...
		char[] candidates=map.get(digit);
		for(int i=0;i<candidates.length;i++)
		{
			arr[index]=candidates[i];
			recursiveCall(digits,index+1,map,arr,result);
		}
	}
